<?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $date = date('D d M Y');
                $update = "UPDATE pages SET content = '{$content}', date = '{$date}' WHERE page_title = 'contact us'";
...
<div class="col-md-10">
			<h4 class="border-bottom p-2 font-weight-bold text-dark">Manage Contact Us Page</h4>
